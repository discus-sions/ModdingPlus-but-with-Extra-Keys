...
enum abstract Action(String) to String from String
{
	...
	//ek update by Discussions on GB and Discord.
	var L1 = "l1";
	var U1 = "u";
	var R1 = "r1";
	var L2 = "l2";
...
//	inline function get_GTSTRUM() return _gtstrum.check();
	...
	public function setKeyboardScheme(scheme:KeyboardScheme, reset = true)
	{
		...
		keyboardScheme = scheme;
		if (!Reflect.hasField(FlxG.save.data, "keys") || !(FlxG.save.data.keys.rollbackvt is Array)) {
			trace('resetting keys');
			FlxG.save.data.ekeys = { 
				"test": [D]
			}
			FlxG.save.data.keys = {
				//4k
		...
		#if (haxe >= "4.0.0")
	//	var controls = CoolUtil.parseJson(FNFAssets.getJson('assets/data/options'));
		switch (scheme)
		{
			...
			case Solo(false) | Solo(true):
				...
				inline bindKeys(Control.FULLSCREEN, [FlxG.save.data.keys.FULLSCREEN]);
				inline bindKeys(Control.PAUSE, [FlxG.save.data.keys.PAUSE]);
				inline bindKeys(Control.RESET, [FlxG.save.data.keys.RESET]);
				...
				inline bindKeys(Control.N0, [FlxKey.fromString(FlxG.save.data.keys.N0Bind)]);
				inline bindKeys(Control.N1, [FlxKey.fromString(FlxG.save.data.keys.N1Bind)]);
				inline bindKeys(Control.N2, [FlxKey.fromString(FlxG.save.data.keys.N2Bind)]);
				inline bindKeys(Control.N3, [FlxKey.fromString(FlxG.save.data.keys.N3Bind)]);
				inline bindKeys(Control.N4, [FlxKey.fromString(FlxG.save.data.keys.N4Bind)]);
				inline bindKeys(Control.N5, [FlxKey.fromString(FlxG.save.data.keys.N5Bind)]);
				inline bindKeys(Control.N6, [FlxKey.fromString(FlxG.save.data.keys.N6Bind)]);
				inline bindKeys(Control.N7, [FlxKey.fromString(FlxG.save.data.keys.N7Bind)]);
				inline bindKeys(Control.N8, [FlxKey.fromString(FlxG.save.data.keys.N8Bind)]);

				inline bindKeys(Control.L1, [FlxKey.fromString(FlxG.save.data.keys.L1Bind)]);
				inline bindKeys(Control.U1, [FlxKey.fromString(FlxG.save.data.keys.U1Bind)]);
				inline bindKeys(Control.R1, [FlxKey.fromString(FlxG.save.data.keys.R1Bind)]);
				inline bindKeys(Control.L2, [FlxKey.fromString(FlxG.save.data.keys.L2Bind)]);
				inline bindKeys(Control.D1, [FlxKey.fromString(FlxG.save.data.keys.D1Bind)]);
				inline bindKeys(Control.R2, [FlxKey.fromString(FlxG.save.data.keys.R2Bind)]);
			case Duo(true):
			...
			case None: // nothing
			case Custom:
				inline bindKeys(Control.UP, FlxG.save.data.keys.keys.up);
				inline bindKeys(Control.DOWN, FlxG.save.data.keys.keys.down);
				inline bindKeys(Control.LEFT, FlxG.save.data.keys.keys.left);
				inline bindKeys(Control.RIGHT, FlxG.save.data.keys.keys.right);
				inline bindKeys(Control.ACCEPT, [Z, SPACE, ENTER]);
				inline bindKeys(Control.BACK, [BACKSPACE, ESCAPE]);
